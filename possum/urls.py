...
urlpatterns += patterns('possum.base.views.manager.printers',
    ...
    url(r'^printers/add/$', 'printer_add', name='printer_add'),
    url(r'^printers/add/(?P<name>[a-zA-Z0-9_-]+)/$', 'printer_added', name='printer_added'),
    url(r'^printers/(?P<printer_id>\d+)/$', 'printer_view', name='printer_view'),
    url(r'^printers/(?P<printer_id>\d+)/kitchen/$', 'printer_change_kitchen', name='printer_change_kitchen'),
    url(r'^printers/(?P<printer_id>\d+)/billing/$', 'printer_change_billing', name='printer_change_billing'),
    url(r'^printers/(?P<printer_id>\d+)/manager/$', 'printer_change_manager', name='printer_change_manager'),
    url(r'^printers/(?P<printer_id>\d+)/width/$', 'printer_select_width', name='printer_select_width'),
    url(r'^printers/(?P<printer_id>\d+)/test/$', 'printer_test_print', name='printer_test_print'),
    url(r'^printers/(?P<printer_id>\d+)/width/set/(?P<number>\d+)/$', 'printer_set_width', name='printer_set_width'),
    url(r'^printers/(?P<printer_id>\d+)/kitchen_header/$', 'kitchen_header', name='printer_kitchen_header'),
    url(r'^printers/(?P<printer_id>\d+)/kitchen_header/(?P<number>\d+)/$', 'kitchen_header', name='printer_kitchen_header'),
)
