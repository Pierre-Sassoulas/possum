...
urlpatterns += patterns('possum.base.views.carte.categories',
                        ...
                        url(r'^carte/categories/(?P<cat_id>\d+)/vat/set/(?P<vat_id>\d+)/$',
...
urlpatterns += patterns('possum.base.views.bill',
                        ...
                        url(r'^bill/(?P<bill_id>\d+)/product/(?P<product_id>\d+)/made_with/(?P<category_id>\d+)/$',
                            'product_set_made_with', name='product_set_made_with'),
                        url(r'^bill/(?P<bill_id>\d+)/sold/(?P<sold_id>\d+)/category/(?P<category_id>\d+)/select/$',
                        ...
                        url(r'^bill/(?P<bill_id>\d+)/sold/(?P<sold_id>\d+)/option/(?P<option_id>\d+)/$', 'sold_option',
                            name='sold_option'),
                        url(r'^bill/(?P<bill_id>\d+)/sold/(?P<sold_id>\d+)/cooking/$',
                            'sold_cooking', name='sold_cooking'),
                        url(r'^bill/(?P<bill_id>\d+)/sold/(?P<sold_id>\d+)/cooking/(?P<cooking_id>\d+)/$',
                            'sold_cooking', name='sold_cooking'),
                        url(r'^bill/(?P<bill_id>\d+)/sold/(?P<sold_id>\d+)/delete/$',
                            'sold_delete', name='sold_delete'),
                        url(r'^bill/(?P<bill_id>\d+)/sold/(?P<sold_id>\d+)/(?P<product_id>\d+)/add/$',
                            'subproduct_add', name='subproduct_add'),
                        url(r'^bill/(?P<bill_id>\d+)/delete/$',
                            'bill_delete', name='bill_delete'),
                        url(r'^bill/(?P<bill_id>\d+)/onsite/$',
                            'bill_onsite', name='bill_onsite'),
                        url(r'^bill/(?P<bill_id>\d+)/payment/$',
                            'prepare_payment', name='prepare_payment'),
                        url(r'^bill/(?P<bill_id>\d+)/payment/view/(?P<payment_id>\d+)/$',
                            'bill_payment_view', name='bill_payment_view'),
                        url(r'^bill/(?P<bill_id>\d+)/payment/delete/(?P<payment_id>\d+)/$',
                            'bill_payment_delete', name='bill_payment_delete'),
                        url(r'^bill/(?P<bill_id>\d+)/payment/type/(?P<type_id>\d+)/$',
                            'type_payment', name='type_payment'),
                        url(r'^bill/(?P<bill_id>\d+)/payment/save/$',
                            'save_payment', name='save_payment'),
                        url(r'^bill/(?P<bill_id>\d+)/payment/count/(?P<number>\d+)/$',
                            'payment_count', name='payment_count'),
                        url(r'^bill/(?P<bill_id>\d+)/print/$',
                            'bill_print', name='bill_print'),
                        url(r'^bill/(?P<bill_id>\d+)/kitchen/$',
...
urlpatterns += patterns('possum.base.views.manager.printers',
                        ...
                        url(r'^printers/(?P<printer_id>\d+)/kitchen/$',
                            'printer_change_kitchen', name='printer_change_kitchen'),
                        url(r'^printers/(?P<printer_id>\d+)/billing/$',
                            'printer_change_billing', name='printer_change_billing'),
                        url(r'^printers/(?P<printer_id>\d+)/manager/$',
                            'printer_change_manager', name='printer_change_manager'),
...
urlpatterns += patterns('possum.base.views.manager.vats',
                        ...
                        url(r'^manager/vats/(?P<vat_id>\d+)/$',
                            'vats_view', name='vats_view'),
                        url(r'^manager/vats/(?P<vat_id>\d+)/change/$',
