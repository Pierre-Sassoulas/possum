...
urlpatterns += patterns('possum.base.views.bill',
                        ...
                        url(r'^bill/' + BIL_RGX + '/' + SLD_RGX + '/options/' + OPT_RGX + '/$', 'sold_options',
                            name='bill_sold_options'),
                        url(r'^bill/' + BIL_RGX + '/sold/' + SLD_RGX + '/view/$',
                            'sold_view',
                            name='sold_view'),
                        url(r'^bill/' + BIL_RGX + '/sold/' + SLD_RGX + '/note/(?P<note_id>\d+)/$', 'sold_note',
                            name='sold_note'),
                        url(r'^bill/' + BIL_RGX + '/sold/' + SLD_RGX + '/option/' + OPT_RGX + '/$', 'sold_option',
                            name='sold_option'),
...
urlpatterns += patterns('possum.base.views.manager.printers',
                        ...
                        url(r'^printers/(?P<printer_id>\d+)/$',
                            'printer_view', name='printer_view'),
                        url(r'^printers/(?P<printer_id>\d+)/kitchen/$',
                            'printer_change_kitchen',
                            name='printer_change_kitchen'),
                        url(r'^printers/(?P<printer_id>\d+)/billing/$',
                            'printer_change_billing',
                            name='printer_change_billing'),
                        url(r'^printers/(?P<printer_id>\d+)/manager/$',
                            'printer_change_manager',
                            name='printer_change_manager'),
                        url(r'^printers/(?P<printer_id>\d+)/width/$',
                            'printer_select_width', name='printer_select_width'),
                        url(r'^printers/(?P<printer_id>\d+)/test/$',
                            'printer_test_print', name='printer_test_print'),
                        url(r'^printers/(?P<printer_id>\d+)/width/set/(?P<number>\d+)/$',
                            'printer_set_width', name='printer_set_width'),
                        url(r'^printers/(?P<printer_id>\d+)/kitchen_header/$',
                            'kitchen_header', name='printer_kitchen_header'),
                        url(r'^printers/(?P<printer_id>\d+)/kitchen_header/(?P<number>\d+)/$',
                            'kitchen_header', name='printer_kitchen_header'),
                        )
...
urlpatterns += patterns('possum.base.views.manager.user',
                        ...
                        url(r'^manager/users/(?P<user_id>\d+)/passwd/$',
                            'users_passwd', name='users_passwd'),
                        url(r'^manager/users/(?P<user_id>\d+)/active/$',
                            'users_active', name='users_active'),
                        url(r'^manager/users/(?P<user_id>\d+)/change/$',
                            'users_change', name='users_change'),
                        url(r'^manager/users/(?P<user_id>\d+)/perm/(?P<codename>p\d+)/$',
