...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Printer.kitchen_lines'
        db.add_column(u'base_printer', 'kitchen_lines',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Printer.kitchen_lines'
        db.delete_column(u'base_printer', 'kitchen_lines')
    ...
    models = {
        ...
        'base.printer': {
            ...
            'kitchen_lines': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
