...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'base_sauce')

        # Deleting field 'Option.nom'
        db.delete_column(u'base_option', 'nom')

        # Adding field 'Option.name'
        db.add_column(u'base_option', 'name',
                      self.gf(
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'base_dish', (
            ('color', self.gf('django.db.models.fields.CharField')
             (default='#ffdd82', max_length=8)),
            ('nom', self.gf('django.db.models.fields.CharField')
             (max_length=60)),
            (u'id', self.gf('django.db.models.fields.AutoField')
             (primary_key=True)),
            ('nom_facture', self.gf('django.db.models.fields.CharField')
             (default='', max_length=35)),
        ))
        db.send_create_signal('base', ['Dish'])

        # Adding model 'Sauce'
        db.create_table(u'base_sauce', (
            ('color', self.gf('django.db.models.fields.CharField')
             (default='#ffdd82', max_length=8)),
            ('nom', self.gf('django.db.models.fields.CharField')
             (max_length=60)),
        ...
        # Adding field 'Option.nom'
        db.add_column(u'base_option', 'nom',
                      self.gf(
                      'django.db.models.fields.CharField')(
                      default='',
                      max_length=16),
        ...
        db.delete_column(u'base_option', 'name')
