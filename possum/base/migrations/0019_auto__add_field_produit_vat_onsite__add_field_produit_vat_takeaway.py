...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Produit.vat_onsite'
        db.add_column(u'base_produit', 'vat_onsite',
                      self.gf(
        ...
        # Adding field 'Produit.vat_takeaway'
        db.add_column(u'base_produit', 'vat_takeaway',
                      self.gf(
                      'django.db.models.fields.DecimalField')(
                      default=0,
                      max_digits=7,
    ...
    def backwards(self, orm):
        # Deleting field 'Produit.vat_onsite'
        db.delete_column(u'base_produit', 'vat_onsite')

        # Deleting field 'Produit.vat_takeaway'
        db.delete_column(u'base_produit', 'vat_takeaway')
