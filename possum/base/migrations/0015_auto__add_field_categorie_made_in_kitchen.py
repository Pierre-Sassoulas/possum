...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Categorie.made_in_kitchen'
        db.add_column(u'base_categorie', 'made_in_kitchen',
                      self.gf(
    ...
    def backwards(self, orm):
        # Deleting field 'Categorie.made_in_kitchen'
        db.delete_column(u'base_categorie', 'made_in_kitchen')
