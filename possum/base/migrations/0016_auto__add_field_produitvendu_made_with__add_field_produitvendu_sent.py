...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProduitVendu.made_with'
        db.add_column(u'base_produitvendu', 'made_with',
                      self.gf(
                      'django.db.models.fields.related.ForeignKey')(default=1,
                                                                    related_name='produit-kitchen',
                                                                    to=orm[
                                                                        'base.Categorie']),
                      keep_default=False)

        # Adding field 'ProduitVendu.sent'
        db.add_column(u'base_produitvendu', 'sent',
                      self.gf(
    ...
    def backwards(self, orm):
        # Deleting field 'ProduitVendu.made_with'
        db.delete_column(u'base_produitvendu', 'made_with_id')

        # Deleting field 'ProduitVendu.sent'
        db.delete_column(u'base_produitvendu', 'sent')
