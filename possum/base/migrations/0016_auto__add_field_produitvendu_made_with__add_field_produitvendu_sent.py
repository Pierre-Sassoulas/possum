...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'base_produitvendu', 'made_with',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='produit-kitchen', to=orm['base.Categorie']),
                      keep_default=False)
    ...
    models = {
        ...
        u'base.produitvendu': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'made_with': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'produit-kitchen'", 'to': u"orm['base.Categorie']"}),
            'prix': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '7', 'decimal_places': '2'}),
