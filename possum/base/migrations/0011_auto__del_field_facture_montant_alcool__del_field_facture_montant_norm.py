...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Facture.montant_alcool'
        db.delete_column(u'base_facture', 'montant_alcool')

        # Deleting field 'Facture.montant_normal'
        db.delete_column(u'base_facture', 'montant_normal')

    def backwards(self, orm):
        # Adding field 'Facture.montant_alcool'
        db.add_column(u'base_facture', 'montant_alcool',
                      self.gf(
        ...
        # Adding field 'Facture.montant_normal'
        db.add_column(u'base_facture', 'montant_normal',
                      self.gf(
                      'django.db.models.fields.DecimalField')(
                      default=0,
                      max_digits=9,
