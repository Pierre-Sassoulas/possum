...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'base_facture', 'category_to_follow_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Categorie'], null=True))

    def backwards(self, orm):

        # Changing field 'Facture.category_to_follow'
        db.alter_column(u'base_facture', 'category_to_follow_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['base.Categorie']))
