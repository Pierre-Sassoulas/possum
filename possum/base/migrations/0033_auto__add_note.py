...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Note'
        db.create_table(u'base_note', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('message', self.gf('django.db.models.fields.CharField')(default='', max_length=35)),
        ))
        db.send_create_signal('base', ['Note'])

        # Adding M2M table for field notes on 'ProduitVendu'
        m2m_table_name = db.shorten_name(u'base_produitvendu_notes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('produitvendu', models.ForeignKey(orm['base.produitvendu'], null=False)),
            ('note', models.ForeignKey(orm['base.note'], null=False))
        ))
        db.create_unique(m2m_table_name, ['produitvendu_id', 'note_id'])


    def backwards(self, orm):
        # Deleting model 'Note'
        db.delete_table(u'base_note')

        # Removing M2M table for field notes on 'ProduitVendu'
        db.delete_table(db.shorten_name(u'base_produitvendu_notes'))
