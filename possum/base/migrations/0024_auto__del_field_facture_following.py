...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field following on 'Facture'
        m2m_table_name = db.shorten_name(u'base_facture_following')
        ...
        db.create_unique(m2m_table_name, ['facture_id', 'follow_id'])

    def backwards(self, orm):
        # Adding field 'Facture.following'
        db.add_column(u'base_facture', 'following',
                      self.gf('django.db.models.fields.related.ForeignKey')(
                          to=orm['base.Follow'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field following on 'Facture'
        db.delete_table(db.shorten_name(u'base_facture_following'))
