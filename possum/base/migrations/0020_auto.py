...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'base_facture_etats'))

    def backwards(self, orm):
        # Adding M2M table for field etats on 'Facture'
        m2m_table_name = db.shorten_name(u'base_facture_etats')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID',
             primary_key=True, auto_created=True)),
            ('facture', models.ForeignKey(orm[u'base.facture'], null=False)),
            ('suivi', models.ForeignKey(orm[u'base.suivi'], null=False))
        ))
        db.create_unique(m2m_table_name, ['facture_id', 'suivi_id'])
