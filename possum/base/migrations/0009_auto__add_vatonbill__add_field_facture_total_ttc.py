    ...
    def forwards(self, orm):
        ...
        db.create_table(u'base_vatonbill', (
            (u'id', self.gf('django.db.models.fields.AutoField')
             (primary_key=True)),
            ('vat', self.gf('django.db.models.fields.related.ForeignKey')
             (related_name='bill-vat', to=orm['base.VAT'])),
            ('total', self.gf('django.db.models.fields.DecimalField')
        ...
        db.create_table(m2m_table_name, (
            ...
            ('vatonbill', models.ForeignKey(
                orm[u'base.vatonbill'], null=False))
        ))
