...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PaiementType.priorite'
        db.delete_column(u'base_paiementtype', 'priorite')

        # Deleting field 'PaiementType.nom_facture'
        db.delete_column(u'base_paiementtype', 'nom_facture')

    def backwards(self, orm):
        # Adding field 'PaiementType.priorite'
        db.add_column(u'base_paiementtype', 'priorite',
                      self.gf(
                      'django.db.models.fields.PositiveIntegerField')(
                      default=0),
                      keep_default=False)

        # Adding field 'PaiementType.nom_facture'
        db.add_column(u'base_paiementtype', 'nom_facture',
                      self.gf(
