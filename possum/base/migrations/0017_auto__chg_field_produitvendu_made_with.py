...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'base_produitvendu', 'made_with_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['base.Categorie']))

    def backwards(self, orm):

        # Changing field 'ProduitVendu.made_with'
        db.alter_column(u'base_produitvendu', 'made_with_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['base.Categorie']))
