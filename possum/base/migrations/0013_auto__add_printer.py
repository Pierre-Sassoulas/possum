...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'base_printer', (
            (u'id', self.gf('django.db.models.fields.AutoField')
             (primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')
             (max_length=40)),
            ('options', self.gf('django.db.models.fields.CharField')
             (max_length=120)),
            ('header', self.gf('django.db.models.fields.TextField')
             (default='')),
            ('footer', self.gf('django.db.models.fields.TextField')
             (default='')),
            ('kitchen', self.gf('django.db.models.fields.BooleanField')
             (default=False)),
            ('billing', self.gf('django.db.models.fields.BooleanField')
             (default=False)),
            ('manager', self.gf('django.db.models.fields.BooleanField')
             (default=False)),
        ))
        db.send_create_signal(u'base', ['Printer'])

    def backwards(self, orm):
        # Deleting model 'Printer'
        db.delete_table(u'base_printer')
