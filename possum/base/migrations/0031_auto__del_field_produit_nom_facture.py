...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Produit.nom_facture'
        db.delete_column(u'base_produit', 'nom_facture')


    def backwards(self, orm):
        # Adding field 'Produit.nom_facture'
        db.add_column(u'base_produit', 'nom_facture',
                      self.gf('django.db.models.fields.CharField')(default='inconnu', max_length=35),
                      keep_default=False)
