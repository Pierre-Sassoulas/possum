...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'base_logtype')

        # Deleting model 'Log'
        db.delete_table(u'base_log')

    def backwards(self, orm):
        # Adding model 'LogType'
        db.create_table(u'base_logtype', (
        ...
        db.send_create_signal(u'base', ['LogType'])

        # Adding model 'Log'
        db.create_table(u'base_log', (
        ...
        db.send_create_signal(u'base', ['Log'])
