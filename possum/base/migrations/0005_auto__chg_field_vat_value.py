...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'base_vat', 'value', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=4))

    def backwards(self, orm):

        # Changing field 'VAT.value'
        db.alter_column(u'base_vat', 'value', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))
    ...
    models = {
        ...
        u'base.vat': {
            ...
            'value': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '4', 'decimal_places': '4'})
        },
        u'base.zone': {
