    ...
    def forwards(self, orm):
        ...
        db.create_table('base_log', (
            ...
            ('type', self.gf('django.db.models.fields.related.ForeignKey')
             (related_name='log-logtype', to=orm['base.LogType'])),
        ))
        ...
        db.create_table('base_couleur', (
            ...
            ('nom', self.gf('django.db.models.fields.CharField')
             (max_length=60)),
            ('red', self.gf('django.db.models.fields.PositiveIntegerField')
             (default=255)),
            ('green', self.gf('django.db.models.fields.PositiveIntegerField')
             (default=255)),
            ('blue', self.gf('django.db.models.fields.PositiveIntegerField')
             (default=255)),
        ))
        ...
        db.create_table('base_categorie', (
            ...
            ('priorite', self.gf(
                'django.db.models.fields.PositiveIntegerField')(default=0)),
            ('surtaxable', self.gf('django.db.models.fields.BooleanField')
             (default=False)),
            ('couleur', self.gf('django.db.models.fields.related.ForeignKey')
             (blank=True, related_name='categorie-couleur', null=True, to=orm['base.Couleur'])),
            ('alcool', self.gf('django.db.models.fields.BooleanField')
             (default=False)),
            ('disable_surtaxe', self.gf(
        ...
        db.create_table('base_cuisson', (
            ...
            ('priorite', self.gf(
                'django.db.models.fields.PositiveIntegerField')(default=0)),
            ('couleur', self.gf('django.db.models.fields.related.ForeignKey')
             (blank=True, related_name='cuisson-couleur', null=True, to=orm['base.Couleur'])),
        ))
        ...
        db.create_table('base_sauce', (
            ...
            ('nom', self.gf('django.db.models.fields.CharField')
             (max_length=60)),
            ('couleur', self.gf('django.db.models.fields.related.ForeignKey')
             (blank=True, related_name='sauce-couleur', null=True, to=orm['base.Couleur'])),
        ))
        ...
        db.create_table('base_accompagnement', (
            ...
            ('nom', self.gf('django.db.models.fields.CharField')
             (max_length=60)),
            ('couleur', self.gf('django.db.models.fields.related.ForeignKey')
             (blank=True, related_name='accompagnement-couleur', null=True, to=orm['base.Couleur'])),
        ))
        ...
        db.create_table('base_produit', (
            ...
            ('categorie', self.gf('django.db.models.fields.related.ForeignKey')
             (related_name='produit-categorie', to=orm['base.Categorie'])),
            ('choix_cuisson', self.gf(
                'django.db.models.fields.BooleanField')(default=False)),
            ('choix_accompagnement', self.gf(
                'django.db.models.fields.BooleanField')(default=False)),
            ('choix_sauce', self.gf('django.db.models.fields.BooleanField')
             (default=False)),
            ('actif', self.gf('django.db.models.fields.BooleanField')
             (default=True)),
            ('prix', self.gf('django.db.models.fields.DecimalField')
        ...
        db.create_table('base_produit_produits_ok', (
            ('id', models.AutoField(verbose_name='ID',
             primary_key=True, auto_created=True)),
            ('from_produit', models.ForeignKey(
                orm['base.produit'], null=False)),
            ('to_produit', models.ForeignKey(orm['base.produit'], null=False))
        ))
        db.create_unique(
            'base_produit_produits_ok',
            ['from_produit_id',
             'to_produit_id'])
        ...
        db.create_table('base_produitvendu', (
            ...
            ('date', self.gf('django.db.models.fields.DateTimeField')
             (auto_now_add=True, blank=True)),
            ('produit', self.gf('django.db.models.fields.related.ForeignKey')
             (related_name='produitvendu-produit', to=orm['base.Produit'])),
            ('cuisson', self.gf('django.db.models.fields.related.ForeignKey')
             (blank=True, related_name='produitvendu-cuisson', null=True, to=orm['base.Cuisson'])),
            ('prix', self.gf('django.db.models.fields.DecimalField')
             (default=0, max_digits=7, decimal_places=2)),
            ('sauce', self.gf('django.db.models.fields.related.ForeignKey')
             (blank=True, related_name='produitvendu-sauce', null=True, to=orm['base.Sauce'])),
            ('accompagnement', self.gf('django.db.models.fields.related.ForeignKey')
             (blank=True, related_name='produitvendu-accompagnement', null=True, to=orm['base.Accompagnement'])),
        ))
        ...
        db.create_table('base_produitvendu_contient', (
            ('id', models.AutoField(verbose_name='ID',
             primary_key=True, auto_created=True)),
            ('from_produitvendu', models.ForeignKey(
                orm['base.produitvendu'], null=False)),
            ('to_produitvendu', models.ForeignKey(
                orm['base.produitvendu'], null=False))
        ))
        db.create_unique(
            'base_produitvendu_contient',
            ['from_produitvendu_id',
             'to_produitvendu_id'])
        ...
        db.create_table('base_paiement', (
            ('id', self.gf('django.db.models.fields.AutoField')
             (primary_key=True)),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')
             (related_name='paiement-type', to=orm['base.PaiementType'])),
            ('montant', self.gf('django.db.models.fields.DecimalField')
             (default=0, max_digits=9, decimal_places=2)),
            ('valeur_unitaire', self.gf('django.db.models.fields.DecimalField')
        ...
        db.create_table('base_statsjourgeneral', (
            ...
            ('valeur', self.gf('django.db.models.fields.DecimalField')
             (default=0, max_digits=9, decimal_places=2)),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')
             (blank=True, related_name='statsjour-logtype', null=True, to=orm['base.LogType'])),
        ))
        ...
        db.create_table('base_statsjourpaiement', (
            ...
            ('valeur', self.gf('django.db.models.fields.DecimalField')
             (default=0, max_digits=9, decimal_places=2)),
            ('paiement', self.gf('django.db.models.fields.related.ForeignKey')
             (blank=True, related_name='statsjour-paiement', null=True, to=orm['base.PaiementType'])),
            ('nb', self.gf('django.db.models.fields.PositiveIntegerField')
             (default=0)),
        ))
        ...
        db.create_table('base_statsjourproduit', (
            ...
            ('valeur', self.gf('django.db.models.fields.DecimalField')
             (default=0, max_digits=9, decimal_places=2)),
            ('produit', self.gf('django.db.models.fields.related.ForeignKey')
             (blank=True, related_name='statsjour-produit', null=True, to=orm['base.Produit'])),
            ('nb', self.gf('django.db.models.fields.PositiveIntegerField')
             (default=0)),
        ))
        ...
        db.create_table('base_statsjourcategorie', (
            ...
            ('valeur', self.gf('django.db.models.fields.DecimalField')
             (default=0, max_digits=9, decimal_places=2)),
            ('categorie', self.gf('django.db.models.fields.related.ForeignKey')
             (blank=True, related_name='statsjour-categorie', null=True, to=orm['base.Categorie'])),
            ('nb', self.gf('django.db.models.fields.PositiveIntegerField')
             (default=0)),
        ))
        ...
        db.create_table('base_zone', (
            ...
            ('nom', self.gf('django.db.models.fields.CharField')
             (max_length=60)),
            ('surtaxe', self.gf('django.db.models.fields.BooleanField')
             (default=False)),
            ('prix_surtaxe', self.gf('django.db.models.fields.DecimalField')
        ...
        db.create_table('base_table', (
            ...
            ('nom', self.gf('django.db.models.fields.CharField')
             (max_length=60)),
            ('zone', self.gf('django.db.models.fields.related.ForeignKey')
             (related_name='table-zone', to=orm['base.Zone'])),
        ))
        ...
        db.create_table('base_suivi', (
            ('id', self.gf('django.db.models.fields.AutoField')
             (primary_key=True)),
            ('facture', self.gf('django.db.models.fields.related.ForeignKey')
             (related_name='suivi-facture', to=orm['base.Facture'])),
            ('etat', self.gf('django.db.models.fields.related.ForeignKey')
             (related_name='suivi-etat', to=orm['base.Etat'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')
             (auto_now_add=True, blank=True)),
        ))
        ...
        db.create_table('base_facture', (
            ...
            ('date_creation', self.gf('django.db.models.fields.DateTimeField')
             (auto_now_add=True, blank=True)),
            ('table', self.gf('django.db.models.fields.related.ForeignKey')
             (blank=True, related_name='facture-table', null=True, to=orm['base.Table'])),
            ('couverts', self.gf(
                'django.db.models.fields.PositiveIntegerField')(default=0)),
            ('montant_normal', self.gf('django.db.models.fields.DecimalField')
             (default=0, max_digits=9, decimal_places=2)),
            ('montant_alcool', self.gf('django.db.models.fields.DecimalField')
             (default=0, max_digits=9, decimal_places=2)),
            ('restant_a_payer', self.gf('django.db.models.fields.DecimalField')
             (default=0, max_digits=9, decimal_places=2)),
            ('saved_in_stats', self.gf(
                'django.db.models.fields.BooleanField')(default=False)),
        ))
        ...
        db.create_table('base_facture_produits', (
            ...
            ('produitvendu', models.ForeignKey(
                orm['base.produitvendu'], null=False))
        ))
        db.create_unique(
            'base_facture_produits',
            ['facture_id',
             'produitvendu_id'])
    ...
    models = {
        'base.accompagnement': {
            ...
            'couleur': (
                ...
                [],
                {'blank': 'True',
                 'related_name': "'accompagnement-couleur'",
                 'null': 'True',
                 'to': "orm['base.Couleur']"}),
            'id': (
        ...
        'base.facture': {
            ...
            'produits': (
                'django.db.models.fields.related.ManyToManyField',
                [],
                {'related_name': "'les produits factures'",
                 'symmetrical': 'False',
        ...
        'base.suivi': {
            ...
            'etat': (
                'django.db.models.fields.related.ForeignKey',
                [],
                {'related_name': "'suivi-etat'",
                 'to': "orm['base.Etat']"}),
            'facture': (
                'django.db.models.fields.related.ForeignKey',
                [],
                {'related_name': "'suivi-facture'",
                 'to': "orm['base.Facture']"}),
            'id': (
                'django.db.models.fields.AutoField',
                [],
