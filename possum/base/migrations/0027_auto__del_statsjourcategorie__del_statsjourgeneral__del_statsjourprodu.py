...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'base_statsjourcategorie')

        # Deleting model 'StatsJourGeneral'
        db.delete_table(u'base_statsjourgeneral')

        # Deleting model 'StatsJourProduit'
        db.delete_table(u'base_statsjourproduit')

        # Deleting model 'StatsJourPaiement'
        db.delete_table(u'base_statsjourpaiement')
        ...
        db.send_create_signal(u'base', ['MonthlyStat'])
        ...
        db.send_create_signal(u'base', ['WeeklyStat'])
        ...
        db.send_create_signal(u'base', ['DailyStat'])

    def backwards(self, orm):
        # Adding model 'StatsJourCategorie'
        db.create_table(u'base_statsjourcategorie', (
            ('categorie', self.gf('django.db.models.fields.related.ForeignKey')
             (related_name='statsjour-categorie', null=True, to=orm['base.Categorie'], blank=True)),
        ...
        db.send_create_signal(u'base', ['StatsJourCategorie'])

        # Adding model 'StatsJourGeneral'
        db.create_table(u'base_statsjourgeneral', (
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')
             (related_name='statsjour-logtype', null=True, to=orm['base.LogType'], blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')
             (primary_key=True)),
            ('valeur', self.gf('django.db.models.fields.DecimalField')
             (default=0, max_digits=9, decimal_places=2)),
        ))
        db.send_create_signal(u'base', ['StatsJourGeneral'])

        # Adding model 'StatsJourProduit'
        db.create_table(u'base_statsjourproduit', (
            ('produit', self.gf('django.db.models.fields.related.ForeignKey')
             (related_name='statsjour-produit', null=True, to=orm['base.Produit'], blank=True)),
            ('nb', self.gf('django.db.models.fields.PositiveIntegerField')
             (default=0)),
            ('valeur', self.gf('django.db.models.fields.DecimalField')
             (default=0, max_digits=9, decimal_places=2)),
        ...
        db.send_create_signal(u'base', ['StatsJourProduit'])

        # Adding model 'StatsJourPaiement'
        db.create_table(u'base_statsjourpaiement', (
            ('nb', self.gf('django.db.models.fields.PositiveIntegerField')
             (default=0)),
            ('valeur', self.gf('django.db.models.fields.DecimalField')
             (default=0, max_digits=9, decimal_places=2)),
            ...
            ('paiement', self.gf('django.db.models.fields.related.ForeignKey')
             (related_name='statsjour-paiement', null=True, to=orm['base.PaiementType'], blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')
             (primary_key=True)),
        ))
        db.send_create_signal(u'base', ['StatsJourPaiement'])
        ...
        u'base.facture': {
            ...
            'paiements': (
                ...
                {'related_name': "'les paiements'",
                 'symmetrical': 'False',
                 'to': u"orm['base.Paiement']"}),
            'produits': (
                'django.db.models.fields.related.ManyToManyField',
                [],
                {'related_name': "'les produits vendus'",
                 'symmetrical': 'False',
                 'to': u"orm['base.ProduitVendu']"}),
            'restant_a_payer': (
                'django.db.models.fields.DecimalField',
                [],
                {'default': '0',
