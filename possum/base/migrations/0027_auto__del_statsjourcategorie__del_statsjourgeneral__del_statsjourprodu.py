...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'base_statsjourcategorie', (
            ('categorie', self.gf('django.db.models.fields.related.ForeignKey')(related_name='statsjour-categorie', null=True, to=orm['base.Categorie'], blank=True)),
        ...
        db.create_table(u'base_statsjourgeneral', (
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='statsjour-logtype', null=True, to=orm['base.LogType'], blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('valeur', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=2)),
        ))
        ...
        db.create_table(u'base_statsjourproduit', (
            ('produit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='statsjour-produit', null=True, to=orm['base.Produit'], blank=True)),
            ('nb', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('valeur', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=2)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.create_table(u'base_statsjourpaiement', (
            ...
            ('valeur', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=2)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('paiement', self.gf('django.db.models.fields.related.ForeignKey')(related_name='statsjour-paiement', null=True, to=orm['base.PaiementType'], blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
